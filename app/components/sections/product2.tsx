        ...
        >
          ...
          <div className="relative group w-[510px] h-[510px] max-sm:w-auto max-sm:h-auto p-4">
            ...
            <Link
              ...
              className="absolute flex justify-center items-center h-[44px] w-[44px] -bottom-0 left-0  rounded-full  transition-colors max-sm:-top-6 max-sm:left-1/2  max-sm:-translate-x-1/2 "
            >
              <svg
                width="44"
                height="44"
